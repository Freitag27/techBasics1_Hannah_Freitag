...
#asking about experience (I learned you can use int(input(...))to specify integers, however I wanted the program to be safe against people typing in random letters as well, this is why I tried it without and int(input)
